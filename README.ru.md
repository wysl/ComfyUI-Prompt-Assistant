...
<details open>
<summary><strong>[15.04.2026] 🔥 V2.0.6</strong></summary>

**Исправления:**
* **Оптимизация привязки подграфов**: Исправлены проблемы с созданием и стабильностью помощника на узлах подграфов (Subgraph) в режимах Node 2.0 (Vue) и LiteGraph. Добавлена поддержка точного сопоставления нескольких одноименных полей ввода.
